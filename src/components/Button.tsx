...
const variantStyles = {
  ...
  outline: {
    ...
    brand: 'border-brand-300 text-brand-600 hover:border-brand-400 hover:bg-brand-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600 active:text-brand-600/70 disabled:opacity-40 disabled:hover:border-brand-300 disabled:hover:bg-transparent',
  },
}
