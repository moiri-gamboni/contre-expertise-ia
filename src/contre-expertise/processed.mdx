...
import image1 from '@/images/contre-expertise/image1.webp'
import image2 from '@/images/contre-expertise/image2.webp'
import image3 from '@/images/contre-expertise/image3.webp'
import image4 from '@/images/contre-expertise/image4.png'
import table from '@/images/contre-expertise/table.png'
import legend from '@/images/contre-expertise/legend.png'
...
6. Les risques liés aux algorithmes de recommandation déjà déployés <Reference>\[50\]</Reference>, <Reference>\[51\]</Reference>, <Reference>\[52\]</Reference> (voir [section 3.2.](#3.2.4-négligence-de-l’impact-dévastateur-des-ia-de-recommandation)4).
...
<Image src={image2} alt="*Figure illustrative extraite de l’article « Pour une IA française tournée vers l’avenir » du Centre pour la Sécurité de l’IA (CeSIA) <Reference>\[14\]</Reference>. Cette figure illustre le changement de paradigme actuel en IA, en comparant l'approche statique du rapport à l'évolution rapide des systèmes autonomes et leurs impacts systémiques potentiels, soulignant ainsi l'importance d'anticiper ces développements.*" /> 
...
<Image src={image3} alt="*Cette figure montre l'évolution projetée du coût annuel mondial de la cybercriminalité, exprimé en trillions de dollars américains. Les données révèlent une croissance accélérée entre 2018 et 2023\. Les coûts devraient passer de 0,86 trillion USD en 2018 à 13,82 trillions USD en 2028\.*" /> 
...
<Image src={image4} alt="*Nombre de membres de la Commission par affiliation(s). La plupart des membres viennent du monde de l'industrie tandis que les académiques, la société civile et les experts en éthique de l'IA sont sous représentés et qu'aucun expert en sécurité de l'IA n'en fait partie.*" /> 
...
<Expert name="BRETTEL Alexandre" role={"Doctorant contractuel en éthique de l'intelligence artificielle à l'Université Grenoble Alpes Responsabilité de l'IA, philosophie de la technique, éthique de l'innovation Soutien"} comment={"« Par rapport à la responsabilité, celle-ci est quelques fois évoquée dans le rapport, mais elle n'est que très superficiellement traitée. Il conviendrait par exemple de leur conseiller de se référer aux travaux relatifs à la responsabilité en éthique et en droit de l'IA. L'éthique est une discipline distincte du droit et la réglementation ne saurait servir de seule méthode de régulation. »"}>Soutien</Expert>
...
<Expert name="HOANG Lê Nguyên" role={"PDG de Calicarpa, Président de Tournesol et Membre du Conseil d'Éthique d'Orange\nChercheur en sécurité et en gouvernance des systèmes d'intelligence artificielle"} >Validation section 3.2.4</Expert>
<Expert name="FOURQUET Jean-Lou" role={"Co-auteur de \"La dictature des algorithmes\", membre de l'association Tournesol, fondateur de la chaîne ApresLaBiere, ancien chroniqueur pour Arrêt sur Images\nNumérique, vulgarisation, IA, transition énergétique"} >Validation section 3.2.4</Expert>
</Experts>
</ReportSection>
