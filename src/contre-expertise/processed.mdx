...
* Sun Aug 25 2024 02:17:14 GMT-0700 (PDT)
* Source doc: Contre-Expertise V1
...
## Contre-Expertise au Rapport de la Commission de l’IA


## Résumé Exécutif

[La Commission de l'intelligence artificielle](https://www.info.gouv.fr/communique/comite-de-lintelligence-artificielle), créée par le gouvernement français et présidée par Mme Bouverot et M. Aghion, a pour mission de positionner la France en leader face aux enjeux de l’IA pour les années à venir. [Son rapport final](https://www.bercynumerique.finances.gouv.fr/le-rapport-ia-notre-ambition-pour-la-france), publié le 13 mars 2024, s'avère être une occasion manquée, malgré l’importance cruciale de ce document pour l'avenir technologique et économique de la France. Notre contre-expertise, soutenue par [X] experts reconnus et [Y] organisations, met en lumière les lacunes et les biais méthodologiques qui entachent ce document.

**Au cœur de notre critique se trouve l'approche profondément non scientifique du rapport**, qui écarte sans aucune justification l'avis d'une grande partie des experts en IA. Face à une situation où de nombreux chercheurs éminents, dont une majorité des experts en sécurité de l'IA, alertent sur des risques potentiellement catastrophiques à court et moyen terme, **la Commission fait le choix de les ignorer**. Cette approche compromet la capacité de la France à anticiper et gérer les défis majeurs posés par l'IA, mettant ainsi en péril la sécurité nationale et l'avenir de notre société.

Notre analyse révèle des défaillances systématiques dans le rapport, que nous pouvons résumer en six critiques principales :



1. Silence injustifié sur les avertissements des experts en IA et sur la littérature scientifique existante.
2. Aucune anticipation des développements futurs de l'IA à court terme.
3. Omission des considérations principales de la sécurité de l'IA.
4. Manipulation des données et des faits pour soutenir une vision excessivement optimiste.
5. Minimisation systématique des risques identifiés, notamment en matière d'emploi et de cybersécurité.
6. Insuffisance de rigueur en comparaison aux rapports similaires d'autres pays.

Ces défaillances sont illustrées par des exemples choquants :
...
Ces manquements s'expliquent en grande partie par la composition même de la Commission, marquée par **des conflits d'intérêts majeurs** et un **manque de diversité d'opinion et d'expertise. **La Commission ne compte aucun expert en sécurité de l'IA et est dominée par des représentants de l'industrie favorables à, et favorisés par, un développement accéléré et peu régulé de l'IA.
...
1. Les omissions cruciales du rapport
2. La minimisation et la distorsion des dangersrisques
...
Premièrement, le rapport souffre d'omissions critiques. Il passe sous silence le domaine scientifique de la sécurité de l'IA, pourtant établi depuis plus de quinze ans [[6]](https://paperpile.com/c/V0trIA/Xy4dz). Il ignore les avertissements de la majorité des experts concernant les risques existentiels, y compris ceux émis par des figures emblématiques comme Stuart Russell [[7]](https://paperpile.com/c/V0trIA/zp3pc), Yoshua Bengio [[8], [9]](https://paperpile.com/c/V0trIA/hnEIi+JT1YF) et Geoffrey Hinton [[10]](https://paperpile.com/c/V0trIA/c8QZ8). De plus, le rapport fait preuve d'un manque flagrant d'anticipation, se concentrant principalement sur les impacts des technologies actuelles sans considérer sérieusement les défis potentiels posés par les innovations à venir.
...
* La seconde approche cite deux études aux résultats divergents : l'une suggère un potentiel de remplacement de 5,1% des emplois [[67]](https://paperpile.com/c/V0trIA/pPX4x), l'autre de 30% [[68]](https://paperpile.com/c/V0trIA/B5SYZ). Le rapport minimise cette disparité alarmante, se focalise uniquement sur les résultats de la première étude et conclut à un effet positif.
...
Face à ces préoccupations majeures, le traitement de la question de l'open source par la Commission de l'IA est alarmant de légèreté. Le rapport affirme d'emblée que l'ouverture des modèles d'IA ne pose "pas de risque supplémentaire significatif" (p.59), une conclusion en contradiction flagrante avec l'étude de GovAI. Cette position repose sur des hypothèses non justifiées et des omissions graves.
...
L'étude <span style="text-decoration:underline;">Future Unscripted</span> [[85]](https://paperpile.com/c/V0trIA/sLQT5) révèle l'ampleur de la transformation en cours :
...
Le rapport de la Commission française sur l'IA se voulait, en principe, aligné sur cette approche. Cependant, il se démarque par ses lacunes flagrantes comparé à d'autres initiatives similaires. Le document échoue à traiter la question avec le sérieux qu'elle mérite, éludant la plupart des risques sans les examiner en profondeur. Il ne citesollicite aucun expert dans les domaines de risques les plus couramment anticipés, tels que les biorisques ou la sécurité informatique, et ne propose donc aucune solution politique ou institutionnelle crédible face à ces enjeux.
...
Pour évaluer la qualité du rapport de la Commission française sur l'IA, nous l'avons comparé à quatre initiatives récentes, reconnues pour leur rigueur et leur influence dans le domaine de la gouvernance de l'IA avancée. Ces documents représentent diverses approches, allant de l'analyse scientifique approfondie à la législation concrète, et couvrent des régions géopolitiques clés.
...
<table>
  <tr>
   ...
   <td><strong><em>EU AI act</em></strong>
   </td>
  ...
  <tr>
   ...
   <td>2 phrases, 0 références (p. 32, 59).
   </td>
   <td>Plusieurs mentions et paragraphes, interview de plusieurs experts en cybersécurité, 7 références.
   </td>
   <td>2 pages (4.1.3), 18 références
   </td>
   <td>Récital 110, et plusieurs chapitres pour encadrer les systèmes à haut risque.
   </td>
   <td>26 mentions concernant les risques et 2 concernant le potentiel pour la défense.
   </td>
  </tr>
  <tr>
   <td><strong>Biorisque</strong>
   </td>
   <td>3 phrases, 1 référence (p.32, 59).
   </td>
   <td>Plusieurs mentions et discussions, 3 références.
   </td>
   <td>3 pages (4.1.4) 20 références.
   </td>
   <td>Récital 110, et plusieurs chapitres pour encadrer les systèmes à haut risque.
   </td>
   <td>12 mentions.
  ...
  <tr>
   ...
   <td>7 pages, 10 références mais analyse biaisee et trompeuse.
   </td>
   <td>
   </td>
   <td>3 pages (4.3.1), 37 références.
   </td>
   <td>Non mentionné.
   </td>
   <td>9 mentions et demande d'un rapport par le <em>Council of Economic Advisers</em> et le <em>Secretary of Labor</em>.
   </td>
  </tr>
  <tr>
   <td><strong>Perte de controle</strong>
   </td>
   <td>1 phrase, 0 référence, risque ridiculisé.
   </td>
   <td>Extrêmement étayé, 20 références.
   </td>
   <td>3 pages (4.2.3), 45 références.
   </td>
   <td>Chapitre 3 et plusieurs autres chapitres pour encadrer les systèmes à haut risque.
   </td>
   <td>1 mention et plusieurs systèmes d'évaluation pour les capacités dangereuses non spécifiquement conçus pour le risque de perte de contrôle..
   </td>
  </tr>
  <tr>
   <td><strong>Guerre informationelle</strong>
   </td>
   <td>1.5 pages, 1 référence.
   </td>
   <td>
   </td>
   <td>2 pages (4.2.1), 34 références.
   </td>
   <td>Récitals 132 et 133.
   </td>
   <td>
   </td>
  </tr>
  ...
  <tr>
   <td><strong>Violations de confidentialite</strong>
   </td>
   <td>2 phrases, 0 référence.
   </td>
   <td>
   </td>
   <td>2 pages (4.3.5), 20 références.
   </td>
   <td>Article 15.
   </td>
   <td>37 mentions et demande au <em>Secretary of Commerce</em> de faire une évaluation des meilleures pratiques dans le domaine sans imposer de restrictions particulières aux développeurs des modèles.
   </td>
  </tr>
  <tr>
   ...
   <td>2 pages, 4.2.2) ,45 références.
   </td>
   <td>Récital 67.
   </td>
   <td>29 mentions et ordonne l'évaluation de ce risque au <em>Secretary of Health and Human Services </em>et au<em> Secretary of Labor</em>.
   </td>
  </tr>
  <tr>
   ...
   <td>Plusieurs mentions (4.2.1 et 4.3.1), 17 références.
   </td>
   <td>Récitals 132 et 133.
   </td>
   <td>Non mentionné.
  ...
  <tr>
   ...
   <td>Le rapport reconnaît le risque et propose des solutions intégrées à des LOE pour mitiger les risques d'escalade.
   </td>
   <td>
   </td>
   <td>Non mentionné.
  ...
  <tr>
   ...
   <td>2 pages, 6 références.
   </td>
   <td>
   </td>
   <td>2 pages, 12 références.
   </td>
   <td>Non mentionné.
   </td>
   <td>Non mentionné.
...
* Les biais discriminatoires que les modèles peuvent intégrer (_ISR_ p. 49-51, loi européenne sur l’IA, Récital 67, _Executive Order_)
...
Le rapport consacre 7 pages à la question de la perte d'emploi, en faisant le risque le plus discuté. Cependant, comme détaillé dans notre discuté en détails dans la section 3.3.2.1, l'analyse présente plusieurs faiblesses :
...
En contraste, l'_ISR_ adopte une approche plus prudente, notant l'incertitude et l'absence de consensus parmi les économistes sur ce sujet (section 4.3.1p.54-56). Il présente une vision plus riche des différentes difficultés liées à cette situation inédite.
...
_Nombre de membres de la commission par affiliation(s). La plupart des membres viennent du monde de l'industrie tandis que les académiques et les experts en éthique de l'IA sont sous représentés et qu'aucun expert en sécurité de l'IA n'en fait partie._
...
Le fait que ces membres influents de la Commission ont signé une lettre adressée à des instances législatives majeures contenant des affirmations scientifiquement erronées, sans les corriger par la suite, remet en question :
...
* Professeur à l'INSEAD, une école privée de management.
...
* Cofondateur de ODIA, entreprise cherchant à convertir du texte en voix via IA. (text-to-speech)
...
* Secrétaire nationale CFDT Cadres, l’union des cadres au syndicat de la CFDT.
* Vice-présidente "workers group" au Comité Économique et Social Européen.
* Salariée d’Orange, société de télécommunications.
...
* Cofondateur et conseiller scientifique de “:probabl” , développeur de logiciel.
* Directeur de recherche à Inria.
* Cofondateur de scikit-learn , un logiciel de modèle d’IA.
...
* Membre du conseil d'administration - Trésorière a Agoranov , un incubateur de startup.
...
* Membre du conseil d’administration de Partnership on AI, coalition visant une utilisation responsable de l'IA.
...
Un changement de paradigme commence à s’opérer dans l'histoire de l'IA au milieu des années 1990 avec l’adoption du connexionnisme. Les approches symboliques en IA, qui dominaient le champ jusqu'alors, sont remplacées par des méthodes permettant aux systèmes de s'adapter à la complexité des données issues du monde réel sans nécessiter la programmation de règles préétablies (Russel & Norvig 2020, .

Les premiers modèles issus de ce paradigme sont probabilistes. Ils sont capables d’analyser de vastes ensembles de données pour identifier des régularités, mais dépendent de l'ajustement manuel de leurs paramètres et de la qualité des données. Souvent de taille modeste, ils sont réputés pour leur transparence et leur interprétabilité, permettant une compréhension claire des processus décisionnels qu'ils emploient.

L'avènement des réseaux neuronaux dans les années 2000 marque le début de l'apprentissage machine, offrant plus de flexibilité et d'adaptabilité que les modèles probabilistes classiques. C’est cependant avec l'apprentissage profond qu'il prend véritablement son essor. En utilisant des réseaux neuronaux multicouches comme les CNN, ce paradigme montre une efficacité remarquable, notamment avec AlexNet, un modèle de reconnaissance d’images qui, en 2012, remporte la compétition ImageNet.

Les réussites de l’apprentissage profond se multiplient ensuite, avec la création de modèles spécialisés dans toutes sortes de domaines, notamment dans des jeux de plus en plus complexes, ce qui est devenu apparent avec la victoire écrasante d’AlphaGo, un modèle de Google Deepmind contre Lee Sedol, un des meilleurs joueurs mondiaux de go en 2016. En 2017, il bat le champion du monde Ke Jie. On parle désormais de « révolution du _deep learning_ ».
...
Cette course à la puissance de calcul est désormais internationale et prend une tournure géopolitique. Les capacités de calcul actuelles sont déjà probablement supérieures à celles strictement nécessaires à la création de modèles bien plus intelligents. Ce phénomène, appelé « _compute overhang_ », désigne une situation où une amélioration des modèles pourrait survenir de manière brusque avec la découverte d’algorithmes plus efficaces, démultipliant soudainement la valeur des capacités de calcul déjà existantes.
...
Le _scaffolding (voir annexe D) _des modèles multimodaux sera un élément clé des systèmes destinés à améliorer leurs compétences. Enfin, les paradigmes précédents de l’histoire l'IA ne sont pas oubliés et un effort important est fourni pour tenter de les appliquer aux modèles actuels, produisant des phénomènes de "cross-pollinisation" pouvant déboucher rapidement sur la création de superintelligences.

La prochaine étape de l’histoire de l’IA est celle des agents autonomes. L’essentiel de la valeur ajoutée de l’intelligence artificielle tient dans sa capacité à exécuter des tâches, efficacement et rapidement, à grande échellesans repos. Pour ce faire, les IA doivent pouvoir agir de manière autonome. Plus elles peuvent agir dans le monde, plus elles sont utiles. Plus elles sont intelligentes, créatives et autonomes, plus elles peuvent agir dans le monde.
